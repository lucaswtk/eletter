...
if (!defined('FILE_CACHE_SUFFIX'))
	define('FILE_CACHE_SUFFIX', '.eletter.txt');   // What to put at the end of all files in the cache directory so we can identify them
if (!defined('FILE_CACHE_PREFIX'))
	define('FILE_CACHE_PREFIX', 'eletter');    // What to put at the beg of all files in the cache directory so we can identify them
...
if (!defined('MAX_HEIGHT'))
	define('MAX_HEIGHT', 2000);       // Maximum image height item 67660 rows
